      ...
      [
        {
          ...
          "reference": "Always give reference. Example: Surah Al-Furqan (25:67). Short reference number is required in this format: "Quran Book Name or Hadith Name (Chapter:Verse)".",
        }
        ...
      ]`,
    },
